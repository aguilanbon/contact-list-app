...
function SecondStep({ setUserDetails }) {
    ...
    return (
        <form action="" className='md:w-96 flex flex-col mt-4'>
            ...
            <div className='w-full flex justify-end py-2 mt-2'>
                <input type="button" value="Submit" className='font-semibold bg-green-400 hover:bg-green-500 text-white py-2 px-4 rounded-md cursor-pointer outline-blue-400' onClick={handleUser} />
            </div>
        </form>
    )
}
