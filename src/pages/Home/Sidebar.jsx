        ...
        <div className='w-auto min-h-screen flex shadow-xl bg-slate-800 text-white flex-col items-center justify-between pb-8 px-2'>
            <div className='flex flex-col'>
                ...
                <Link to='/profile' className='flex p-2 hover:bg-slate-900 rounded-lg'>
                    <div before={users?.requests.length} className={users?.requests.length <= 0 ? `` : `before:content-[attr(before)] before:absolute before:p-1 before:-ml-2 before:-mt-1 before:text-xs before:rounded-full before:bg-red-500 before:h-4 before:w-4 before:flex before:items-center before:justify-center`}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
